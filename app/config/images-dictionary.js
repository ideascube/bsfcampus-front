define(
	...
	function(Constants) {
		...
		return {
			...
			richTextIcon: Constants.imagesPath + 'iconmonstr-text-file-4-icon-256_BLUE.png',
			videoIcon: Constants.imagesPath + 'iconmonstr-video-camera-icon-256_BLUE.png',
			exerciseIcon: Constants.imagesPath + 'iconmonstr-pen-12-icon-256_BLUE.png',
			audioIcon: Constants.imagesPath + 'iconmonstr-sound-audio-icon-256_BLUE.png'
